...
export const PodGroupAIProvider = ({ children }) => {
  ...
  const { podMembers, getMemberData, getMemberDisplayName } = useContext(PodContext);
  ...
  const getGroupBunkRecommendation = async (selectedUids) => {
    ...
    for (const uid of selectedUids) {
      ...
      let displayName = getMemberDisplayName(uid);
